...
!function(root,factory){"use strict";var cdnjs;"function"==typeof define&&define.amd?(cdnjs="https://cdnjs.cloudflare.com/ajax/libs/",requirejs.config({paths:{"es5-shim":cdnjs+"es5-shim/4.3.1/es5-shim.min","es6-shim":cdnjs+"es6-shim/0.33.13/es6-shim.min",json3:cdnjs+"json3/3.3.2/json3.min",cycle:"https://rawgit.com/Xotic750/cycle-x/master/lib/cycle-x.min.js"},shim:{cycle:{deps:["es5-shim","json3","es6-shim"]}}}),define(["es5-shim","json3","es6-shim","cycle"],factory)):"object"==typeof exports?(require("es5-shim"),require("json3"),require("es6-shim"),require("cycle-x"),factory()):factory()}(this,function(){});
},{"cycle-x":3,"es5-shim":4,"es6-shim":5,"json3":6}],2:[function(require,module,exports){
